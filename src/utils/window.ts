export const browserDefaultLanguage = () =>
...
export const getItemInLocalStorage = (key: any) =>
  JSON.parse(window.localStorage.getItem(key) || "{}");

export const setItemInLocalStorage = (key: any, value: any) =>
  window.localStorage.setItem(key, JSON.stringify(value));

export const deleteLocalStorage = (key: any) =>
  window.localStorage.removeItem(key);

export const getItemInSessionStorage = (key: any) =>
